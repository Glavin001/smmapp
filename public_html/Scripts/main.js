...
window.addEventListener("orientationchange", function() {
    ...
    if (window[ navigator.getModuleName() ] && window[ navigator.getModuleName() ].onOrientationChange)
        window[ navigator.getModuleName() ].onOrientationChange();

});
window.addEventListener("resize", function() {
    // Module On Resize Event
    if (window[ navigator.getModuleName() ] && window[ navigator.getModuleName() ].onResize)
        window[ navigator.getModuleName() ].onResize();
})
$(window).smartresize(function() {
    displayAppGrid();

    // Module On Smart Resize Event
    if (window[ navigator.getModuleName() ] && window[ navigator.getModuleName() ].onSmartResize)
        window[ navigator.getModuleName() ].onSmartResize();
});
