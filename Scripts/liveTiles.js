 ...
 * 
 * Description:
 * This file handles the Live Tile wall on the home page.
 *  
 */


function loadLiveTiles() {
    // Require Node.JS support for 
    
}

function displayLiveTiles() {
    // Displays the HTML for Live Tiles 
    // Requires loadLiveTiles() be called prior.
